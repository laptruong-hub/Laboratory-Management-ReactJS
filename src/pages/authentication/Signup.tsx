      ...
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          <div style={styles.formGroup}>
            ...
            <input type="text" placeholder="Nhập họ và tên đầy đủ" style={styles.input} required />
          </div>
          ...
          <div style={styles.formGroup}>
            ...
            <input type="email" placeholder="email@example.com" style={styles.input} required />
          </div>
          ...
          <div style={styles.formGroup}>
            ...
            <input type="tel" placeholder="0912 345 678" style={styles.input} required />
          ...
          <div style={styles.infoBox}>
            <p style={styles.infoText}>Dữ liệu của bạn được xử lý theo tiêu chuẩn bảo mật HIPAA, GDPR và BPI</p>
          </div>
